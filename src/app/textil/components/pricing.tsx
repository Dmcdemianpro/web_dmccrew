...
const categories: Category[] = [
  ...
  },
  {
    nombre: "Canguros",
    icon: ShieldCheck,
    matcher: (p) => p.producto.toLowerCase().startsWith("canguro"),
  },
  {
    nombre: "Polerones Polo",
    icon: Zap,
    matcher: (p) => p.producto.toLowerCase().startsWith("polerón polo"),
  },
  {
    nombre: "Polerones Cierre",
    icon: Package,
    matcher: (p) => p.producto.toLowerCase().startsWith("polerón cierre"),
  },
];
